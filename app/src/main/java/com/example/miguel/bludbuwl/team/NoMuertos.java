...
public class NoMuertos extends Equipo {
    ...
    public HashSet<Jugador> getJugadores() {
        if (jugadores.isEmpty()) {
            ...
            jugadores.add(new Jugador("Esqueletos", 40000, 5, 3, 2, 7, new HashSet<>(Arrays.asList(Habilidad.CABEZADURA.getNombre(), Habilidad.REGENERACION.getNombre())),16));
            jugadores.add(new Jugador("Zombis", 40000, 4, 3, 2, 8, new HashSet<>(Arrays.asList(Habilidad.REGENERACION.getNombre())),16));
            jugadores.add(new Jugador("Necrofagos", 70000, 7, 3, 3, 7, new HashSet<>(Arrays.asList(Habilidad.ESQUIVAR.getNombre())),4));
            ...
            jugadores.add(new Jugador("Hombres Lobo Nigrománticos", 120000, 3, 5, 1, 9, new HashSet<>(Arrays.asList(Habilidad.GOLPEMORTIFERO.getNombre(), Habilidad.REGENERACION.getNombre())),2));
